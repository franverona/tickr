...
export default function TaskDetail({
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Header */}
      <div className="border-surface-700 flex h-12 shrink-0 items-center gap-3 border-b px-4">
        <button
          onClick={onToggleSidebar}
          title={isSidebarCollapsed ? 'Show list' : 'Hide list'}
          className="text-surface-400 hover:text-surface-100 hidden h-6 w-6 shrink-0 items-center justify-center rounded transition-colors md:flex"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
